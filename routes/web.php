...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('SendO2ConsumptionDataToAPI/{odas_facility_id}',[App\Http\Controllers\OxygenDataController::class,'UpdateFacilitO2ConsumptionData'])->name('update.facility.oxygen.consumption');
