                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        {{-- <a href="index" class="d-block auth-logo">
                                            <img src="{{ URL::asset('/assets/images/odas.png') }}" alt="" height="52"
                                                class="auth-logo-dark">
                                            <img src="{{ URL::asset('/assets/images/odas.png') }}" alt="" height="18"
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted">Sign in to continue to ODAS Data Sync Dashboard.</p>
                                        </div>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>
                                            ...
                                            </script> ODAS Data Sync Dashboard.
                                            <br/>Developed by
                                            <a href="https://www.kopouweb.com" target="_blank">Kopou Web Solutions</a>
                                        </p>
                                    </div>
                                </div>
