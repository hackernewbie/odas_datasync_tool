...
@section('title') Dashboard - ODAS Data Sync @endsection

@section('content')

    @component('components.breadcrumb')
        @slot('li_1') Dashboard @endslot
        @slot('title') ODAS Data Sync Dashboard @endslot
    @endcomponent
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <p class="text-muted mb-0 ">Deptt. of Health, Meghalaya</p>
                        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Latest 25 Processes Runs</h4>
                            ...
                            <tbody>
                                @forelse ($processes as $process)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-pill @if($process->status == 'Success') badge-soft-success @else badge-soft-danger @endif font-size-11">{{$process->status}}</span>
                                        </td>
                                        <td>
                                            {{\Carbon\Carbon::parse($process->updated_at)->format('d, M y H:i:s')}}
                                        </td>
                                        {{-- <td>
                                            Action
                                        </td> --}}
